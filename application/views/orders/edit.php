      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
              <?php if (!$order_data['order']['parent_bill']) : ?>
                Chỉnh sửa đơn hàng
              <?php endif; ?>
              <?php if ($order_data['order']['parent_bill']) : ?>
                Chỉnh sửa Đơn Hàng Con
              <?php endif; ?>

              <?php if (!$order_data['order']['parent_bill']) : ?>
                <small><a href="<?php echo base_url('orders/subbill/') . $order_data['order']['id'] ?> ">
                    <div class="btn btn-sm btn-warning">Thêm Hóa Đơn</div>
                  </a></small>
              <?php endif; ?>
            </h3>
          </div>
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="date" class="col-sm-12 control-label">Ngày: <?php echo date('Y-m-d') ?></label>
              </div>
              <div class="form-group">
                <label for="time" class="col-sm-12 control-label">Ngày: <?php echo date('h:i a') ?></label>
              </div>
              ...
              <div class="col-md-4 col-xs-12 pull pull-left">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" <?php if ($order_data['order']['parent_bill']) : ?> readonly="true" <?php endif; ?> id="customer_name" name="customer_name" placeholder="Nhập vào tên khách hàng" required="true" value="<?php echo $order_data['order']['customer_name'] ?>" autocomplete="off" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="customer_address" <?php if ($order_data['order']['parent_bill']) : ?> readonly="true" <?php endif; ?> name="customer_address" placeholder="Nhập vào địa chỉ khách hàng" value="<?php echo $order_data['order']['customer_address'] ?>" autocomplete="off">
                  </div>
                </div>

                <div class="form-group">
                  <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Số điện thoại khách hàng</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="customer_phone" name="customer_phone" <?php if ($order_data['order']['parent_bill']) : ?> readonly="true" <?php endif; ?> placeholder="Nhập vào số điện thoại khách hàng" value="<?php echo $order_data['order']['customer_phone'] ?>" autocomplete="off">
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 col-xs-12 pull pull-right">
                ...
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-5 control-label">Tổng số tiền</label>
                  <div class="col-sm-7">
                ...
                <?php if ($is_vat_enabled == true) : ?>
                  <div class="form-group">
                    <label for="vat_charge" class="col-sm-5 control-label">Thuế Vat <?php echo $company_data['vat_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                ...
                <div class="form-group">
                  <label for="net_amount" class="col-sm-5 control-label">Tổng cộng</label>
                  <div class="col-sm-7">
                ...
                <div class="form-group">
                  <label for="paid_status" class="col-sm-5 control-label">Trạng thái đơn hàng</label>
                  <div class="col-sm-7">
            ...
            <div class="box-footer">
              ...
              <a target="__blank" href="<?php echo base_url() . 'orders/printDiv/' . $order_data['order']['id'] ?>" class="btn btn-default">In hóa đơn</a>
              <button type="submit" class="btn btn-primary">Lưu thay đổi</button>
              <?php if ($order_data['order']['parent_bill']) : ?>
                <a href="<?php echo base_url('orders/update/') . $order_data['order']['parent_bill'] ?>" class="btn btn-warning">Trở về</a>
              <?php endif; ?>
              <?php if (!$order_data['order']['parent_bill']) : ?>
                <a href="<?php echo base_url('orders/') ?>" class="btn btn-warning">Trở về</a>
              <?php endif; ?>
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          html += '</select>' +
            ...
            '<td><input type="text" name="rate_value[]" onkeyup="getTotal(' + row_id + ')" id="rate_value_' + row_id + '" class="form-control"></td>' +
