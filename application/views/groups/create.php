            ...
            <form role="form" action="<?php base_url('groups/create') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="group_name" name="group_name" placeholder="Nhập vào tên nhóm">
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('groups/') ?>" class="btn btn-warning">Trở về</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
